...
public class DamageIndicatorMessage {
    ...
    public DamageIndicatorMessage(float damage, double x, double y, double z, boolean isCritical, boolean isShotgun) {
        this.damage = damage;
    ...
    private static void handleClient(DamageIndicatorMessage msg) {
        if (msg.isShotgun) {
            com.levanilla.rogue.client.ClientEventHandler.addShotgunDamageIndicator(msg.x, msg.y, msg.z, msg.damage, msg.isCritical);
        } else {
            com.levanilla.rogue.client.ClientEventHandler.addDamageIndicator(msg.x, msg.y, msg.z, msg.damage, msg.isCritical);
        }
    }
}
